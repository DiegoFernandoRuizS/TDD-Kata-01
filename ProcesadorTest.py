...
class ProcesadorTest(TestCase):
    ...
    def test_procesador_1(self):
        self.assertEquals(Procesador().procesar("1"), [1,2], "Lista con 1 dato")

    def test_procesador_2(self):
        self.assertEquals(Procesador().procesar("1,2"), [1,2], "Lista con 2 datos")

    def test_procesador_n(self):
        self.assertEquals(Procesador().procesar("1,2,3,4"), {4}, "Lista con 4 datos")
